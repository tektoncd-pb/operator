...
func createOrUpdateConfigMap(ctx context.Context, kubeclient kubernetes.Interface, namespace, configMapName string, tektonPrunerConfig v1alpha1.TektonPrunerConfig) error {
	// Create YAML from globalConfig
	yamlBytes, err := yaml.Marshal(tektonPrunerConfig)
	if err != nil {
